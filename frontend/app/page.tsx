...
import { getPreferredStablecoin, redirectToDeposit } from "../lib/stablecoins";
...
export default function Home() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[480px] min-h-screen bg-[#f5f2eb] text-[#0d0d0b] font-sans flex flex-col shadow-xl border-x border-[rgba(13,13,11,0.08)]">
      ...
      <nav className="fixed bottom-0 left-0 right-0 mx-auto w-full max-w-[480px] bg-white border-t border-[rgba(13,13,11,0.08)] grid grid-cols-4 py-2.5 z-20">
        <button
          onClick={() => setActiveTab("explore")}
